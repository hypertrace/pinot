...
@TaskExecutorFactory
public class CustomPurgeTaskExecutorFactory implements PinotTaskExecutorFactory {
  ...
  public String getTaskType() {
    return MinionTaskConstants.CusmtomPurgeTask.TASK_TYPE;
  }

  @Override
  public PinotTaskExecutor create() {
    return new CustomPurgeTaskExecutor();
  }
}
