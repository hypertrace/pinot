...
public abstract class ControllerTest {
  ...
  protected static final String DEFAULT_DATA_DIR =
      new File(
          FileUtils.getTempDirectoryPath(), "test-controller-" + System.currentTimeMillis()).getAbsolutePath();
  ...
  public Map<String, Object> getDefaultControllerConfiguration() {
    ...
    properties.put(
        ControllerConf.CONTROLLER_HOST, LOCAL_HOST);
  ...
  public static class FakeBrokerResourceOnlineOfflineStateModelFactory extends
    ...
    public static class FakeBrokerResourceOnlineOfflineStateModel extends StateModel {
      ...
      public void onBecomeOnlineFromOffline(
  ...
  protected void addSchema(Schema schema) throws IOException {
    ...
    Assertions.assertEquals(postMethod.getStatusCode(), 200);
  }
  ...
  protected TableConfig getOfflineTableConfig(String tableName) {
    ...
    Assertions.assertNotNull(offlineTableConfig);
  ...
  protected String getBrokerTenantRequestPayload(String tenantName, int numBrokers) {
    return new Tenant(
        TenantRole.BROKER, tenantName, numBrokers, 0, 0).toJsonString();
  }
  ...
  private static String constructResponse(
